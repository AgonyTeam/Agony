...
function pandorasChest:RemoveChain(collectibleType, RNG)
...
Agony:AddCallback(ModCallbacks.MC_USE_ITEM, pandorasChest.RemoveChain , CollectibleType.AGONY_C_PANDORASCHEST4)
Agony:AddCallback(ModCallbacks.MC_USE_ITEM, pandorasChest.RemoveChain , CollectibleType.AGONY_C_PANDORASCHEST3)
Agony:AddCallback(ModCallbacks.MC_USE_ITEM, pandorasChest.RemoveChain , CollectibleType.AGONY_C_PANDORASCHEST2)
Agony:AddCallback(ModCallbacks.MC_USE_ITEM, pandorasChest.RemoveChain , CollectibleType.AGONY_C_PANDORASCHEST1)
Agony:AddCallback(ModCallbacks.MC_USE_ITEM, pandorasChest.RemoveChain , CollectibleType.AGONY_C_PANDORASCHEST0)
