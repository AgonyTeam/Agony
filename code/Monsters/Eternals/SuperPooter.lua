...
function EternalSuperPooter:ai_main(entity)
	...
	if (entity.Type == EntityType.ENTITY_POOTER and rng:RandomFloat() < Agony.ETERNAL_SPAWN_CHANCE and entity.FrameCount <= 10 and entity.SubType ~= 15 and entity.Variant == 1) then
		entity.SubType = 15;
